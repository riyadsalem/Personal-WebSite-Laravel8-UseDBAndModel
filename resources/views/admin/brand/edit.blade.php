@extends('admin.admin_master')
                ...
                @endif
                 -->
                  ...
                  <form  action="{{ url('brand/update/'.$brands->id) }}" method="POST" enctype="multipart/form-data">
                      ...
                      <!-- الفكرة من السطر السابق وهي اني بدي احط الصورة القديمة بمكان مخفي ولما اعدل ال brand يتم حذف هضه الصورة القديمة  -->
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Updatre Brand Name</label>
  ...
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Updatre Brand Image</label>
  ...
  <div class="mb-3">
      <img src="{{ asset($brands -> brand_image) }}" style="width:480px; height:230px;">
  </div>
